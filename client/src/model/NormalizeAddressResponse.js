...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudmersiveValidateApiClient.NormalizeAddressResponse = factory(root.CloudmersiveValidateApiClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>NormalizeAddressResponse</code>.
   * Result of validating a street address
   * @alias module:model/NormalizeAddressResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>NormalizeAddressResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NormalizeAddressResponse} obj Optional instance to populate.
   * @return {module:model/NormalizeAddressResponse} The populated <code>NormalizeAddressResponse</code> instance.
   */
