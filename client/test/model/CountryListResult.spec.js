...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.CountryListResult();
  });
  ...
  describe('CountryListResult', function() {
    it('should create an instance of CountryListResult', function() {
      // uncomment below and update the code to test CountryListResult
      //var instane = new CloudmersiveValidateApiClient.CountryListResult();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.CountryListResult);
    });
