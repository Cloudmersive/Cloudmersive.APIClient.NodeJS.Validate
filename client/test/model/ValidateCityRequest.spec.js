...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.ValidateCityRequest();
  });
  ...
  describe('ValidateCityRequest', function() {
    it('should create an instance of ValidateCityRequest', function() {
      // uncomment below and update the code to test ValidateCityRequest
      //var instane = new CloudmersiveValidateApiClient.ValidateCityRequest();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.ValidateCityRequest);
    });
