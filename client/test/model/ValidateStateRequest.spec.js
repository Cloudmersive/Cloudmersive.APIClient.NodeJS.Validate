...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.ValidateStateRequest();
  });
  ...
  describe('ValidateStateRequest', function() {
    it('should create an instance of ValidateStateRequest', function() {
      // uncomment below and update the code to test ValidateStateRequest
      //var instane = new CloudmersiveValidateApiClient.ValidateStateRequest();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.ValidateStateRequest);
    });
