...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.GeolocateStreetAddressResponse();
  });
  ...
  describe('GeolocateStreetAddressResponse', function() {
    it('should create an instance of GeolocateStreetAddressResponse', function() {
      // uncomment below and update the code to test GeolocateStreetAddressResponse
      //var instane = new CloudmersiveValidateApiClient.GeolocateStreetAddressResponse();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.GeolocateStreetAddressResponse);
    });
