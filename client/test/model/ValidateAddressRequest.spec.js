...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.ValidateAddressRequest();
  });
  ...
  describe('ValidateAddressRequest', function() {
    it('should create an instance of ValidateAddressRequest', function() {
      ...
      //var instane = new CloudmersiveValidateApiClient.ValidateAddressRequest();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.ValidateAddressRequest);
    });
