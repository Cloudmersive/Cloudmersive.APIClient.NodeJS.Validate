...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudmersiveValidateApiClient.ParseAddressResponse();
  });
  ...
  describe('ParseAddressResponse', function() {
    it('should create an instance of ParseAddressResponse', function() {
      // uncomment below and update the code to test ParseAddressResponse
      //var instane = new CloudmersiveValidateApiClient.ParseAddressResponse();
      //expect(instance).to.be.a(CloudmersiveValidateApiClient.ParseAddressResponse);
    });
